...
public   Cursor cursor;
    ...
    private void setupViews() {
        ...
        sdcardImages.setOnItemClickListener(images.this);
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        ...
        if (cursor != null) {
            ...
            try {
               ...
               bitmap.compress(Bitmap.CompressFormat.JPEG, 60, ba);
                byte[] imageBytes = ba.toByteArray();
                encodedImage = Base64.encodeToString(imageBytes, Base64.DEFAULT);
                Intent in=new Intent(images.this,CameraPhotoCapture.class);
            Log.d("image",encodedImage);
                in.putExtra("image",encodedImage);
                startActivity(in);
                finish();
...
GridView.OnClickListener l = new View.OnClickListener() {
    @Override
